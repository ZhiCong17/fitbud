...
if @tracker.persisted?
  json.success true
  json.form "testtest"
  # json.form render(partial: "exercise_plans/form", formats: :html, locals: {tracker: Tracker.new})
  # json.inserted_item render(partial: "exercise_plans/form", formats: :html, locals: {tracker: @tracker})
else
  json.success false
